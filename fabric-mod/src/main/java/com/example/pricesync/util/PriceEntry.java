...
/** One row of the /worth GUI: an item with its price. */
public class PriceEntry {
    ...
    public boolean pricesEqual(PriceEntry other) {
        ...
        return this.buy == other.buy && this.sell == other.sell && this.stackPrice == other.stackPrice;
    }
    ...
    public boolean equals(Object o) {
        ...
        return buy == that.buy && sell == that.sell && Objects.equals(id, that.id);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, buy, sell);
    }
}
